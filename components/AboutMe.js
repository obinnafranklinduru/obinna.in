        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-row flex-wrap mt-8">
              ...
              />
              <img
                src="https://uploads-ssl.webflow.com/6433e6f821ae13dd37394322/64393ec631a32b4da0ee030c_ethersjs.png"
                className="h-20 w-20 mx-4 my-4"
                title="Ether.Js"
                alt="Ether.Js"
              />
              ...
              />
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKJ731l1uafX-VIHrjEBIGRtQlZ12SgsFYMQ&usqp=CAU"
                className="h-20 w-20 mx-4 my-4"
                title="Hardhat"
                alt="Hardhat"
              />
